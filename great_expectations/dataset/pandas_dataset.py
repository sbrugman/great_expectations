            ...
            if min_value is not None and max_value is not None:
                if allow_cross_type_comparisons:
                    ...
                    if (
                        ...
                        != isinstance(min_value, string_types)
                    ) or (
                        isinstance(val, string_types)
                        != isinstance(max_value, string_types)
                    ):
                        raise TypeError(
                ...
                if allow_cross_type_comparisons:
                    ...
                    if isinstance(val, string_types) != isinstance(
                        max_value, string_types
                    ):
                        raise TypeError(
                            "Column values, min_value, and max_value must either be None or of the same type."
                        )
