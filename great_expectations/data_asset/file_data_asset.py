...
class FileDataAsset(MetaFileDataAsset):
        ...
        if expected_max_count != None and expected_min_count != None:
            truth_list = [
                ...
                if (
                    ...
                    and len(comp_regex.findall(line)) <= expected_max_count
                )
                else False
                for line in _lines
            ]
            ...
            truth_list = [
                True if (len(comp_regex.findall(line)) <= expected_max_count) else False
                for line in _lines
            ]

        elif expected_min_count != None:
            truth_list = [
                True if (len(comp_regex.findall(line)) >= expected_min_count) else False
                for line in _lines
            ]
        else:
    ...
    def expect_file_line_regex_match_count_to_equal(
        ...
        return [
            True if (len(comp_regex.findall(line)) == expected_count) else False
            for line in _lines
        ]
